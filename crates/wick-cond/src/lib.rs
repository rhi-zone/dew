...
//!
//! ```text
//! wick-core (AST: Compare, And, Or, If)
//!     │
//!     ▼
//! wick-cond (backend helpers)
//!     │
...
//!     │
//!     ▼
//! domain crates (wick-scalar, wick-linalg, wick-complex, wick-quaternion)
//!     use wick-cond helpers in their backend modules
//! ```
//!
//! # Features
//!
